...
def upgrade() -> None:
    ...
    if 'item' not in existing_tables:
        op.create_table(
            ...
            sa.Column('nft_contract_address', sa.String(length=255), nullable=True),
            sa.Column('nft_transaction_hash', sa.String(length=255), nullable=True),
            sa.Column('nft_metadata_uri', sa.String(length=500), nullable=True),
            sa.Column('is_nft_enabled', sa.Boolean(), nullable=False),
